...
void Camera::update(Keyboard &k, Mouse &m, float delta_time) {
...
glm::mat4 &Camera::get_view_matrix() { return _perspecitve_view; };

void Camera::process_mouse_moviment(Mouse &m, bool constrian_pitch) {
...
void Camera::process_keyboard(Keyboard &k, float delta_time) {
...
glm::mat4 &Camera::get_projection() { return _perspecitve_projection; }
